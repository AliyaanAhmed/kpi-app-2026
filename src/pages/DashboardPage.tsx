...
function MetricCard({
  ...
  const numericValue = typeof value === 'number' ? value : Number(String(value).split('/')[0]) || index + 2
  const progress = Math.min(96, Math.max(18, numericValue * 8 + index * 7))
    ...
    >
      <div className="relative flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-1 font-display text-4xl font-extrabold tracking-tight">{value}</p>
      ...
      <div className="relative mt-5">
        ...
        <div className="h-2 rounded-full bg-primary-tint">
          <motion.div
